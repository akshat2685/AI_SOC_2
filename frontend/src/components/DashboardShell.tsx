          ...
          <div className="flex items-center gap-2.5">
            ...
            <div className="min-w-0">
              ...
              <div className="flex flex-wrap gap-1.5 items-center">
                ...
                {user.premium && (
                  <span className="inline-flex items-center gap-0.5 text-[8px] font-bold text-indigo-400 bg-indigo-950/40 border border-indigo-800/40 px-1.5 py-0.5 rounded-full uppercase tracking-wider">
